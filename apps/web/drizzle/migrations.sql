...
CREATE TABLE IF NOT EXISTS `fleet_apps` (
  ...
  `github_repo`      TEXT,
  `forgejo_repo`     TEXT,
  `repo_primary`     TEXT NOT NULL DEFAULT 'github',
  ...
  `logout_path`      TEXT NOT NULL DEFAULT '/logout',
  `confirm_path`     TEXT NOT NULL DEFAULT '/auth/confirm',
  `reset_path`       TEXT NOT NULL DEFAULT '/reset-password',
  `public_signup`    INTEGER NOT NULL DEFAULT 1,
  `providers`        TEXT NOT NULL DEFAULT 'apple,email',
